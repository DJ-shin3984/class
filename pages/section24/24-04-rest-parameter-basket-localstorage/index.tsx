...
import {type IBoard, type IQuery, type IQueryFetchBoardsArgs } from '../../../src/commons/types/generated/type'
...
export default function StaticRoutedPage(): JSX.Element {
  ...
  const onClickBasket = (basket: IBoard) => (event) => {
    ...
    // delete asIsBasket.__typename // 안좋은 코드 (저장 원본 data를 건들인다.)
    const { __typename, ...REST } = tempBasket
